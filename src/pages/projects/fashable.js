...
import fashable from "../../images/fashable.png";
    ...
    <Layout>
      ...
      <div className="mb-10 mx-10 sm:mx-20 xl:mx-40 2xl:mx-80">
        ...
        <p className="mx-auto font-poppins text-center text-gray-800 text-lg mt-2">
          Fashable is an e-commerce platform proposed by XNFY Lab and being
          ...
          preferences and interactions within the platform. Fashable also allows
          ...
          single branded, Fashable creates a unique experience that simulates a
